...
extern const OperationState StreamLoadStateDidInit;
extern const OperationState StreamLoadStateDidProcess;
...
- (void)loadDidInit:(StreamLoad *)load;
- (void)loadDidProcess:(StreamLoad *)load;
